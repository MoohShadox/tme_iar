...
class DDPG_Agent():
    ...
    def __init__(self, state_size, action_size, random_seed):
        ...
        self.critic_local = DDPG_Critic(state_size, action_size, random_seed).to(device)
        self.critic_target = DDPG_Critic(state_size, action_size, random_seed).to(device)
    ...
    def store_policy(self,env_name,score):
        ...
        torch.jit.save(traced, "data/policies/"+"DDPGAgent"+ str(env_name) + "#" + str(score) +".zip")
